...
public class Cambio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Cambio at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String valor1=request.getParameter("mon");
        int mon=Integer.parseInt(valor1);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (mon == 1) {
                monto=monto/6.96;
                 out.println("<h2>"+dinero+" bolivianos es igual a "+monto+" dolares</h2>");
            }
            //dolares a bolivianos
            else{
            monto=monto*6.96;
             out.println("<h2>"+dinero+" dolares es igual a "+monto+" bolivianos</h2>");
            }
            }
            out.println("</body>");
            out.println("</html>");
